            ...
            <aside id="sidebar" :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'"
                ...
                <nav class="flex-1 px-4 space-y-1 overflow-y-auto custom-scrollbar custom-scrollbar-dark">
                    ...
                    @if(auth()->user()->isAdmin())
                        ...
                        <a href="{{ route('admin.users.index', 'student') }}"
    class="sidebar-link {{ request()->routeIs('admin.users.*') && request()->segment(3) == 'student' ? 'sidebar-link-active' : 'sidebar-link-inactive' }}">
    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
...
<a href="{{ route('admin.users.index', 'admin') }}"
    class="sidebar-link {{ request()->routeIs('admin.users.*') && request()->segment(3) == 'admin' ? 'sidebar-link-active' : 'sidebar-link-inactive' }}">
    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
