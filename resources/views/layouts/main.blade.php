        ...
        <div class="flex h-screen overflow-hidden" x-data="{ sidebarOpen: false }">
            ...
            <aside id="sidebar" :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'"
                ...
                <nav class="flex-1 px-4 space-y-1 overflow-y-auto custom-scrollbar">
                    <div class="px-4 mb-4">
                        <p class="text-[10px] font-bold text-slate-600 uppercase tracking-widest">Main Menu</p>
                    </div>
                    ...
                    @elseif(auth()->user()->isTeacher())
                        ...
                        <a href="{{ route('teacher.subjects.index') }}"
                            class="sidebar-link {{ request()->routeIs('teacher.sections.*') ? 'sidebar-link-active' : 'sidebar-link-inactive' }}">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
